...
px_void PX_FontDrawChar(px_surface *psurface, px_int x,px_int y,px_uchar ASCI,px_color Color )
{
	unsigned short i, j;
...
px_void PX_FontDrawText(px_surface *psurface,px_int x,px_int y,PX_FONT_ALIGN align,const px_char *Text,px_color Color)
{
	px_uchar TempChar;
	px_int resX=x;
	px_int xlen=0;
